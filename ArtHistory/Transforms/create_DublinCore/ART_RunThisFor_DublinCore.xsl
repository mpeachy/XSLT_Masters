        ...
        <input xmlns:dc="http://purl.org/dc/elements/1.1/"
            ...
            <xsl:for-each select="collection('xml/collection.xml')/root/row">
                <digitalObject>
                    ...
                    <file><xsl:value-of select="normalize-space(Accession)"
                    />.tif</file>
                    ...
                    <ac:comment>ArtBatchTransform: <xsl:value-of  select="current-dateTime()"/></ac:comment>
                    ...
                    <!-- this portion inserts the boilerplate visibility information -->    
